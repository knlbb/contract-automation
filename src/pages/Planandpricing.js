...
function planandpricing() {
  return (
    <>
    <div className='justify-center items-center flex flex-col pb-24 m-24 '>
    <div class="">
            ...
            <div class="pt-24 flex flex-row">
                <div class="w-96 p-8 bg-white text-center rounded-3xl pr-16 shadow-xl">
                    ...
                    <div class="pt-8">
                        ...
                        <p class="font-semibold text-gray-400 text-left pt-5 flex items-center">
                          <svg class="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                          Get started with <span class="text-black"> messaging</span>
                        </p>
                        <p class="font-semibold text-gray-400 text-left pt-5 flex items-center">
                        ...
                        <a href="#" class="">
                            <p class="w-full py-4 bg-blue-600 mt-8 rounded-xl text-white flex items-center justify-center">
                ...
                <div class="w-80 p-8 bg-gray-900 text-center rounded-3xl text-white border-4 shadow-xl border-white transform scale-125">
                    ...
                    <div class="pt-8">
                        <p class="font-semibold text-gray-400 text-left flex items-center">
                          <svg class="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                          Get started with <span class="text-white "> messaging</span>
                        </p>
                        <p class="font-semibold text-gray-400 text-left pt-5 flex items-center">
                          <svg class="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                          Get started with <span class="text-white "> messaging</span>
