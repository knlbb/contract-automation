...
const SidebarComponent = ({ children, collapseBehavior = 'collapse', collapsed: isCollapsed = false, theme: customTheme = {}, ...props }) => {
    const theme = (0, mergeDeep_1.mergeDeep)((0, ThemeContext_1.useTheme)().theme.sidebar, customTheme);
    return ((0, jsx_runtime_1.jsx)(SidebarContext_1.SidebarContext.Provider, { value: { isCollapsed }, children: (0, jsx_runtime_1.jsx)("aside", { "aria-label": "Sidebar", hidden: isCollapsed && collapseBehavior === 'hide', className: (0, classnames_1.default)(theme.root.base, theme.root.collapsed[isCollapsed ? 'on' : 'off']), ...props, children: (0, jsx_runtime_1.jsx)("div", { className: theme.root.inner, children: children }) }) }));
};
